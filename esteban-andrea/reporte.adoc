...
<a href="https://www.codecogs.com/eqnedit.php?latex=|size(th_mx)&space;-&space;size(th_min)|&space;\leq&space;1" target="_blank"><img src="https://latex.codecogs.com/gif.latex?|size(th_mx)&space;-&space;size(th_min)|&space;\leq&space;1" title="|size(th_mx) - size(th_min)| \leq 1" /></a>
