...
<img src="http://www.sciweavers.org/tex2img.php?eq=%7Csize%28th_mx%29%20-%20size%28th_min%29%7C%20%5Cleq%201&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="|size(th_mx) - size(th_min)| \leq 1" width="253" height="18" />
